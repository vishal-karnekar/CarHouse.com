...
<img src="img//f1.jpg" class="rounded mx-auto d-block w-50 mb-2 mt-2" alt="...">
...
<!--update delete  -->
<p class="fs=4 fw-bold d-flex justify-content-center">For any Correction From Above Purchase<a  class="text-decoration-none" href="update.jsp">&nbsp &nbsp Update From Here</a></p>
<p class="fs=4 fw-bold d-flex justify-content-center">Want Remove Order<a  class="text-decoration-none" href="delete.jsp">&nbsp &nbsp Delete From Here</a></p>
